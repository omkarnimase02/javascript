...
// const ans = multiplyBy5(3); 
// console.log(ans);

// for(let i=1;i<=10;i++){
//     console.log(`5 ${i} ja = ${multiplyBy5(i)}`);
// }

//fun 2 -> using the prototype

// this. -> set the curr context,  which one ask that should t=be first
function createUser(userName, score){
    this.userName =userName
    this.score = score
}

// using protype access the property
